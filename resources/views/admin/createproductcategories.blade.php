    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content" style="background-color: rgba(0,0,0,.03);">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-2">
                        <h4 class="headerborder1">Product Categories / New</h4>
                    </div>
                    <div class="col-md-2">
                        <button type="button" class="btn btn-outline-info mt-1">Save</button>
                        <button type="button" class="btn btn-outline-secondary mt-1">Discard</button>
                    </div>
                        ...
                        <div class="card">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="row">
                                            <div class="col-lg-12 bordercol">
                                                <i class="fa-solid fa-list"></i> <span class="ml-3">0</span><br>
                                                <p class="mb-0 ml-4">Products</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row mt-2">
                                    <div class="col-lg-6">
                                        <h6>Category</h6>
                                        <input type="email" placeholder="E.G. Lamps" id="email-input" name="email-input" class="form-control">
                                        <div class="card-body card-block">
                                            <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                <div class="row form-group">
                                                    <div class="col col-md-4"><label class=" form-control-label">Parent Category :
                                                        </label></div>
