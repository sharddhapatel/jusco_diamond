                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                 CANCEL-PACKET/2022/00027
                                                </label>
                                            </td>
                                            <td>Ankush</td>
                                            <td>14/08/2022 11:35:34</td>
                                            <td>KOHINOOR WEEK PCS</td>
                                            <td><button type="button" class="btn btn-success btn-sm float-left">Approved</button></td>
                                        </tr>
                                        <tr>
                                            <td>1</td>
                                            <td> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                                        ...
                                        <tr>
                                            ...
                                            <td>14/08/2022 11:35:34</td>
                                            <td>KOHINOOR WEEK PCS</td>
                                            <td><button type="button" class="btn btn-danger btn-sm float-left">Cancelled</button></td>
                                        </tr>
                                        <tr>
                                            <td>1</td>
                                            <td> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
