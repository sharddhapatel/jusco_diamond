...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{ url('centerdepartment') }}"><span>Boiling</span></a>
        ...
        <div class="card-header">
            <strong class="card-title"><a href="{{ url('centerdepartment') }}"><i class="fa-solid fa-table-columns"></i></a> <a href="{{ url('boiling1') }}">Boiling</a></strong>
            <ul class="stockul">
                <li class="stockli"><a href="{{ url('boiling1') }}">Boiling</a></li>
                <li class="stockli mt-2"><a class=" mt-1" data-bs-toggle="modal" data-bs-target="#receiveModal">Receive</a></li>
                <li class="stockli"><a href="{{ url('boiling1lots') }}">Lots</a></li>
                <li class="stockli"><a href="{{ url('boiling1packets') }}">Packets</a></li>
                <li class="stockli"><a class=" mt-1" data-bs-toggle="modal" data-bs-target="#returnstockModal">Return</a></li>
                <li class="stockli"><a href="{{ url('boilingend') }}">Boiling End</a></li>
            </ul>
        ...
        <div class="content" style="background-color: rgba(0,0,0,.03);">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-2">
                        <h4 class="headerborder1"> Boiling / New </h4>
                    </div>
                    <div class="col-md-7">
                    ...
                    <div class="col-lg-8 mt-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs mt-4" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="Boilinglines-tab" data-toggle="tab" href="#Boilinglines" role="tab" aria-controls="home" aria-selected="true">Boiling Lines</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content pl-3 p-1" id="myTabContent">
                                    <div class="tab-pane fade show active" id="Boilinglines" role="tabpanel" aria-labelledby="Boilinglines-tab">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card-body">
                                                    <table class="table">
