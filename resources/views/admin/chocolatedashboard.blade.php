    ...
    <div id="right-panel" class="right-panel">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="card">
                                            <div class="card-body card-block">
                                                ...
                                                <div class="button">
                                                    <button id="start_{{ $ans->id }}" class="start_button"
                                                        onclick="start({{ ($k+1) }})">Start</button>
                                                    {{-- <button id="reset_{{ $k }}" onclick="reset()">Reset</button> --}}
                                                    <button id="stop_{{ $ans->id }}" class="stop_button"
                                                        onclick="stop({{ ($k+1) }})">Stop</button>
                                                </div>
        ...
        <script>
            ...
            function timer(id) {
                ...
                document.getElementById("timer_" + id).innerHTML = dispHour + ":" + dispMin + ":" + dispSec;
            }
            ...
            $(document).on('click', '.start_button', function () {
                ...
                /*var formData = new FormData();
                formData.append("id", id.replace('start_', ''));
                $.ajax({
                    headers: {
                        'X-CSRF-TOKEN': "{{ csrf_token() }}",
