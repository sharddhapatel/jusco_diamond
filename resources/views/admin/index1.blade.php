                        ...
                        <div class="card mt-5">
                            <div class="card-body">
                                <div class="mx-auto d-block">
                                    <a href="{{ url('boil') }}"><i class="fa-solid fa-calculator"></i></a>
                                    <h5 class="text-sm-center mt-2 mb-1">Boil &</h5>
                                    <div class="location text-sm-center">Cleaning</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="card">
                            <div class="card-body">
                                <div class="mx-auto d-block">
                                    <a href="{{ url('seed') }}"><i class="fa-solid fa-gem"></i></a>
                                    <h5 class="text-sm-center mt-2 mb-1">Seed</h5>
                    ...
                    <div class="col-md-2">
                        <div class="card">
                            <div class="card-body">
                                <div class="mx-auto d-block">
                                    <a href="{{ url('centerdepartment') }}"><i class="fa-solid fa-building"></i></a>
                                    <h5 class="text-sm-center mt-2 mb-1">Center</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="card">
                            <div class="card-body">
                                <div class="mx-auto d-block">
                                    <a href="{{ url('laser') }}"><i class="fa-solid fa-pencil"></i></a>
                                    <h5 class="text-sm-center mt-2 mb-1">Laser</h5>
                                    <div class="location text-sm-center">Department</div>
                                </div>
                            </div>
                        </div>
