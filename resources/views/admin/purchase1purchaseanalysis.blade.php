                        ...
                        <div class="card">
                            <ul class="stockul">
                                ...
                                <div class="col-md-3 stockli">
                                    <a href="{{ url('purchase1purchaseanalysis') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-chart-column"></i></button></a>
                                    <a href=""><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-chart-area"></i></button></a>
                                    <a href=""><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-chart-pie"></i></button></a>
                                    <a href=""><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrow-up-wide-short"></i></button></a>
                                    <a href=""><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrow-down-short-wide"></i></button></a>
                                </div>
