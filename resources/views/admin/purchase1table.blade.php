                                ...
                                <table class="table table-bordered" style="width: 25%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="2" class="text-center"><i class="fa-solid fa-plus"></i> Total</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            <th scope="row"><i class="fa-solid fa-minus"></i> Total</th>
                                            <td>3</td>
                                            <td>20,062.04</td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><i class="fa-solid fa-plus"></i> ELEMENT DIAMOND </th>
                                            <td>1</td>
                                            <td>20,050.00</td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><i class="fa-solid fa-plus"></i> MIX </th>
                                            <td>1</td>
                                            <td>0.00</td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><i class="fa-solid fa-plus"></i> XYZ </th>
                                            <td>1</td>
                                            <td>12.04</td>
                                        </tr>
                                    </tbody>
