    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('insertcancelpackets') }}" method="post" enctype="multipart/form-data" >
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-lg-6">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4">
                        <h4 class="headerborder1">Cancel Packets </h4>
                    </div>
                    <div class="col-md-4">
                    </div>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('cancelpackets') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                        <a href="{{ url('cancelpacketlist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                        ...
                                        <div class="card-body card-block">
                                            <form action="#" method="post" class="form-horizontal">
                                                <div class="row form-group1">
                                                    <div class="col col-md-12"><label for="hf-email" class=" form-control-label font_size">CANCEL-PACKET/2022/00025</label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    <div class="col col-md-12"><label for="hf-password" class=" form-control-label font_size">DATE: 14/08/2022 11:35:34</div>
                                                </div>
                                            </form>
                                        </div>
                                        <div class="card-header">
                                            <button type="button" class="btn btn-success btn-sm float-left">Approved</button>
                                            <button type="button" class="btn btn-info btn-sm float-right">D</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-3">
                                    <div class="card">
                                        ...
                                        <div class="card-header">
                                            <button type="button" class="btn btn-danger btn-sm float-left">Cancelled</button>
                                            <button type="button" class="btn btn-info btn-sm float-right">D</button>
                                        </div>
                                    </div>
                                </div>
