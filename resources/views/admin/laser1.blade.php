            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4 float-left">
                        <a href="">
                            <h4 class="headerborder1">Laser</h4>
                        </a>
                    </div>
                    <div class="col-md-7">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('laser1') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                        <a href="{{ url('laserlist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
