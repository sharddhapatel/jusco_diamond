            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-xs-6 col-sm-6">
                        <div class="row">
                            <div class="col-lg-3">
                                <a href="{{ url('clickmachinemanagement') }}">
                                <div class="card card2">
                                    <div class="card-header cardheader1">
                                        <strong><i class="fa-solid fa-keyboard"></i> A1</strong>
                                        <p  class="float-right" style="margin: 0px;">H:0.62</p>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="#" method="post" class="form-horizontal">
                                            <div class="row form-group1">
                                                <div class="col col-md-6"><label for="hf-email" class=" form-control-label">Lot:</label></div>
                                                <div class="col col-md-6"><label for="hf-email" class=" form-control-label">MRG6-LOT286-16</label></div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-6"><label for="hf-password" class=" form-control-label">GH:1.49</label></div>
                                                <div class="col col-md-6"><label for="hf-email" class=" form-control-label">TH:2.11</label></div>
                                            </div>
                                            <div class="row form-group1">
                                                <div class="col col-md-2"></div>
                                                <div class="col col-md-8"><label for="hf-email" class=" form-control-label">115H 30M 30S</label></div>
                                                <div class="col col-md-2"></div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card card2">
                                    <div class="card-header cardheader1">
                                        <strong><i class="fa-solid fa-keyboard"></i> A1</strong>
                                        <a type="" class="float-right">H:0.62</a>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="#" method="post" class="form-horizontal">
                                            <div class="row form-group1">
