                                ...
                                <table class="table table-bordered" style="width: 60%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="9" class="text-center"><i class="fa-solid fa-minus"></i> Total</th>
                                            <th colspan="3"></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <th></th>
                                            <th colspan="3" class="text-center"><i class="fa-solid fa-plus"></i> ELEMENT DIAMOND </th>
                                            <th colspan="3" class="text-center"><i class="fa-solid fa-plus"></i> MIX</th>
                                            <th colspan="3" class="text-center"><i class="fa-solid fa-plus"></i> XYZ </th>
                                            <th colspan="3"></th>
                                        </tr>
                                        <tr>
                                            <th></th>
