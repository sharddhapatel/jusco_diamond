    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4">
                        <h4 class="headerborder1">Party</h4>
                    </div>
                    <div class="col-md-4">
                    </div>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('partylist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                                ...
                                <form action="#" method="post" class="form-horizontal">
                                    <div class="row form-group1 mt-2">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="col col-md-8"><i class="fa-solid fa-clock"></i></div>
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-header">
                                <strong>BHARATBHAI JIVANI</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="#" method="post" class="form-horizontal">
                                    <div class="row form-group1 mt-2">
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-header">
                                <strong>MANISHBHAI SAVANI</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="#" method="post" class="form-horizontal">
                                    <div class="row form-group1 mt-2">
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-header">
                                <strong>RAMESHBHAI DONDA</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="#" method="post" class="form-horizontal">
                                    <div class="row form-group1 mt-2">
