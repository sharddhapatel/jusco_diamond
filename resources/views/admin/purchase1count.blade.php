                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="12" class="text-center"><i class="fa-solid fa-minus"></i> Total</th>
                                            <th colspan="4"></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <th></th>
                                            <th colspan="4" class="text-center"><i class="fa-solid fa-plus"></i> ELEMENT DIAMOND </th>
                                            <th colspan="4" class="text-center"><i class="fa-solid fa-plus"></i> MIX</th>
                                            <th colspan="4" class="text-center"><i class="fa-solid fa-plus"></i> XYZ </th>
