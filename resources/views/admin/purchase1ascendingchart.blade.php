                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="mb-3">Ascending</h4>
                                                <canvas id="barChartascending" width="668" height="333" style="display: block; height: 267px; width: 535px;" class="chartjs-render-monitor"></canvas>
                                            </div>
                                        </div>
                                    </div>
                                </div>
