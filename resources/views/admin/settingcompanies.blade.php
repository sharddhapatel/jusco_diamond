    ...
    <div id="right-panel" class="right-panel">
                    ...
                    <div class="header-left">
                        ...
                        <div class="form-inline">
                            <form class="search-form" method="get" name="search">
                                {{ csrf_field()}}
                                <input class="form-control mr-sm-2" name="search" value="{{ $company }}" type="text" placeholder="Search ..." aria-label="Search">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4">
                        <h4 class="headerborder1">Companies</h4>
                    </div>
                    <div class="col-md-4">
                    </div>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4 float-left">
                        <a href="{{ url('createsettingcompanies') }}">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('settingcompanieslist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                        <a href="{{ url('settingcompanies') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">Company Name</th>
                                            <th>Partner</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $data=App\Models\company::get();?>
                                        @foreach($data as $ans)
                                        <tr>
                                           
                                            <td>{{ $ans->id }}</td>
                                            <td> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                                                <label class="form-check-label" for="flexCheckDefault">{{ $ans->name }}
                                                </label>
                                            </td>
                                            <td>{{ $ans->name }}</td>
