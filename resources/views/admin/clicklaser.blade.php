        ...
        <div class="content" style="background-color: rgba(0,0,0,.03);">
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <a href=""><button type="button" class="btn btn-outline-secondary mt-1"> Cut </button></a>
                    </div>
                    ...
                    <div class="col-lg-8 mt-4">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card-body card-block">
                                            <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="row form-group1">
                                                    <div class="col col-md-4"><label class=" form-control-label">Chocolate.Weight(Ct) : </label></div>
                                                    <div class="col-12 col-md-8">
                                ...
                                <ul class="nav nav-tabs mt-4" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Laser Lines</a>
                                    </li>
                                    <li class="nav-item">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="card-body card-block">
                                                        <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            <div class="row form-group1">
                                                                <div class="col col-md-4"><label class=" form-control-label">DLC Weight(Ct) : </label></div>
                                                                <div class="col-12 col-md-8">
                                                                    <p class="form-control-static">0.00</p>
                                                                </div>
                                                            </div>
                                                            <div class="row form-group1">
                                                                <div class="col col-md-4"><label class=" form-control-label">DM.Weight(Ct): </label></div>
                                                                <div class="col-12 col-md-8">
                                                                    <p class="form-control-static">0.00</p>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row form-group1">
                                                                <div class="col col-md-4"><label class=" form-control-label">Image End : </label></div>
                                                                <div class="col-12 col-md-8">
                                                                    <img src="" alt="">
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card-body card-block">
                                                    <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                        ...
                                                        <div class="row form-group1">
                                                            <div class="col col-md-4"><label class=" form-control-label">Other Image End : </label></div>
                                                            <div class="col-12 col-md-8">
                                                                <img src="" alt="">
                                                            </div>
                                                        </div>
