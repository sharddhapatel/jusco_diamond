    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4">
                        <h4 class="headerborder1">Users</h4>
                    </div>
                    <div class="col-md-4">
                    </div>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('settinguserslist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                        <a href="{{ url('settingusers') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button type="button" class="btn btn-success btn-sm float-right mt-1" style="border-radius: 50%;padding: 0.4rem;"></button>
                            </div>
                                    ...
                                    <div class="row form-group1 mt-2">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="row form-group1">
                                                <div class="col col-md-7"><label for="hf-email" class=" form-control-label font_size"><i class="fa fa-envelope"></i> Account</label></div>
                                                <div class="col col-md-5"><label for="hf-email" class=" form-control-label font_size">English (US)</label></div>
                                            </div>
                                        </div>
                                    </div>
                                </form>
