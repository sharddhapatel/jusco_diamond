                        ...
                        <div class="card">
                            <ul class="stockul">
                                <li class="stockli nav-item dropdown"><a class="nav-link dropdown-toggle mt-2" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="background: #198754;">Mesures</a>
                                    <ul class="dropdown-menu mt6" aria-labelledby="navbarDropdown">
                                        ...
                                        <li><a class="dropdown-item" href="{{ url('purchase1currentlyrate') }}">Currency Rate</a></li>
                                        <li><a class="dropdown-item" href="{{ url('purchase1taxes') }}">Taxes</a></li>
                                        <li class="group-result"><i class="fa  fa-check"></i> Total</li>
                                        <li>
                                            <a class="dropdown-item" href="{{ url('purchase1untaxtedamount') }}">Untaxted Amount</a>
                                        </li>
                                        <li><a class="dropdown-item" href="{{ url('purchase1count') }}"><i class="fa  fa-check"></i> Count</a></li>
                                ...
                                <div class="col-md-3 stockli">
                                    ...
                                    <a href="{{ url('purchase1tableexpand') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="bordercolorwhite"></th>
                                            <th colspan="15" class="text-center"><i class="fa-solid fa-minus"></i> Total</th>
                                            <th colspan="5"></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <th></th>
                                            <th colspan="5" class="text-center"><i class="fa-solid fa-plus"></i> ELEMENT DIAMOND </th>
                                            <th colspan="5" class="text-center"><i class="fa-solid fa-plus"></i> MIX</th>
                                            <th colspan="5" class="text-center"><i class="fa-solid fa-plus"></i> XYZ </th>
                                        ...
                                        <tr>
                                            <th scope="row"><i class="fa-solid fa-plus"></i> Total</th>
                                            <td>1</td>
                                            <td>20,050.00</td>
                                            <td>1.0</td>
                                            <td>50.00</td>
