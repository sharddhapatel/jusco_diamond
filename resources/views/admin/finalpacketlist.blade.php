...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card-header">
            <strong class="card-title"><a href="">Final Stock</a></strong>
            <ul class="stockul">
                <li class="stockli mt-2"><a href="#">Batch</a></li>
                <li class="stockli mt-2"><a href="#">Packets</a></li>
                <li class="stockli mt-2"><a href="#">Final Packets</a></li>
                <li class="stockli nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Configuration
                    </a>
                    <ul class="dropdown-menu mt6" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="#">Batch Sequence</a></li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('finalpacketlist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                        <a href=""><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">Seq Final Name</th>
                                            <th>Name</th>
                                            <th>Height(Micron)</th>
                                            <th>Length(MM)</th>
                                            <th>Width(MM)</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>3.24</td>
                                            <td>2.0</td>
                                            <td>26.77 <i class="fa-solid fa-folder-plus"></i> Add Detail <i class="fa-solid fa-clock-rotate-left"></i> History</td>
                                        </tr>
                                        <tr>
                                            <td>1</td>
                                            <td> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                                            ...
                                            <td>3.24</td>
                                            <td>2.0</td>
                                            <td>26.77 <i class="fa-solid fa-folder-plus"></i> Add Detail</td>
                                        </tr>
                                        <tr>
                                            <td>1</td>
                                            <td> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
