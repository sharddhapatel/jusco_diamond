    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4">
                        <h4 class="headerborder1">Products</h4>
                    </div>
                    <div class="col-md-4">
                    </div>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4 float-left">
                        <a href="{{ url('createpurchase1products') }}">
                    ...
                    <div class="col-md-2 float-right">
                        <a href="{{ url('purchase1products') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                        <a href="{{ url('purchase1productslist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-header">
                                <strong class="float-right"><i class="fa fa-star-o"></i></strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="#" method="post" class="form-horizontal">
                                    <div class="row form-group1 mt-2">
                                        <div class="col-lg-3">
                                            <img src="{{ URL::asset('admin/assets/img/products.jpg') }}" alt="" style="border: 1px solid lightgray;">
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="col col-md-8"><label for="hf-email" class=" form-control-label font_size">SEED</label></div>
                                            <div class="col col-md-8"><label for="hf-email" class=" form-control-label font_size">Price : Rs.1.00</label></div>
                                        </div>
                                    </div>
                                </form>
                            </div>
