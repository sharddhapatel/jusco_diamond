                    ...
                    <div class="header-left">
                        ...
                        <div class="form-inline">
                            <form class="search-form" method="get" name="search">
                                {{ csrf_field()}}
                                <input class="form-control mr-sm-2" name="search" value="{{ $packet }}" type="text" placeholder="Search ..." aria-label="Search">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('insertstockpackets') }}" method="post" enctype="multipart/form-data" >
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-lg-6">
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('stock1') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                        <a href="{{ url('stocklist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php $data=App\Models\stockpacket::get(); ?>
                                        @foreach($data as $ans)
                                        <tr>
                                            ...
                                            <td>{{ $ans->width }}</td>
                                            <td>{{ $ans->pcs }}</td>
                                            <td>{{ $ans->weight }} <i class="fa-solid fa-clock-rotate-left"></i> History</td>
                                        </tr>
                          @endforeach
                                    </tbody>
                                </table>
