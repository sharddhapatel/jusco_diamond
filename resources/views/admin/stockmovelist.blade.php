            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4 float-left">
                        <a href="{{ url('createstockmove') }}"><button type="button" class="btn btn-outline-secondary mt-1">Create</button></a>
                    </div>
                    <div class="col-md-7">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('stockmovelist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                                        ...
                                        <div class="card-body card-block">
                                            <form action="#" method="post" class="form-horizontal">
                                                <div class="row form-group1">
                                                    ...
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size">17/08/2022 10:38:02</label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    <div class="col col-md-6"><label for="hf-password" class=" form-control-label font_size">Source : ASSIGN</label></div>
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size"></label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    <div class="col col-md-6"><label for="hf-password" class=" form-control-label font_size">From : Stock</label></div>
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size">To : Chocolate</label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    <div class="col col-md-6"><label for="hf-password" class=" form-control-label font_size">Pcs : 7.00</label></div>
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size">Weight : 12.02</label></div>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
