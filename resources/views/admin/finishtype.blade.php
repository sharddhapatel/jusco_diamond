                    ...
                    <div class="col-md-4 float-left">
                        ...
                        <div class="modal fade" id="addpacketsModal1" tabindex="-1" aria-labelledby="addpacketsModalLabel" aria-hidden="true">
                             ...
                             <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                     <form action="{{ url('insertfinishtype') }}" method="post" enctype="multipart/form-data" >
                                         {{ csrf_field() }}
                                         <div class="row">
                                             <div class="col-lg-6">
                                                 <div class="card-body card-block">
...
<td> <button type="submit" class="btn btn-outline-secondary mt-1"><a href="finishtyperemove/{{ $ans->id}}"> Remove </a></button></td>
