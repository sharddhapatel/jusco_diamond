            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4 float-left">
                        <h4 class="headerborder1"> Batch </h4>
                    </div>
                    <div class="col-md-7">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('finalstock') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                        <a href="{{ url('finalstocklist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            <form action="#" method="post" class="form-horizontal">
                                                ...
                                                <div class="row form-group1">
                                                    <div class="col col-md-5"><label for="hf-password" class=" form-control-label font_size"><i class="fa-solid fa-circle"></i>Stock Final</label></div>
