            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('finalpacket') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                        <a href="{{ url('finalpacketkarben') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>3.24</td>
                                            <td>2.0</td>
                                            <td>26.77 <i class="fa-solid fa-folder-plus spancolortd"></i><span class="spancolortd"> Add Detail</span> <i class="fa-solid fa-clock-rotate-left spancolortd"></i><span class="spancolortd"> History</span></td>
                                        </tr>
                                        <tr>
                                            <td>1</td>
                                            <td> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                                            ...
                                            <td>3.24</td>
                                            <td>2.0</td>
                                            <td>26.77 <i class="fa-solid fa-folder-plus spancolortd"></i><span class="spancolortd"> Add Detail</span></td>
                                        </tr>
                                        <tr>
                                            <td>1</td>
                                            <td> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
