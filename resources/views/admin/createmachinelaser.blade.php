                    ...
                    <div class="col-lg-8 mt-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs mt-4" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="Equipments-tab" data-toggle="tab" href="#Equipments" role="tab" aria-controls="home" aria-selected="true">Equipments</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="Description-tab" data-toggle="tab" href="#Description" role="tab" aria-controls="home" aria-selected="true">Description</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="Machineimage-tab" data-toggle="tab" href="#Machineimage" role="tab" aria-controls="home" aria-selected="true">Machine Image</a>
                                    </li>

                                </ul>
                                <div class="tab-content pl-3 p-1" id="myTabContent">
                                    <div class="tab-pane fade show active" id="Equipments" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card-body">
                                                    <table class="table">
                                    ...
                                    <div class="tab-pane fade show" id="Machineimage" role="tabpanel" aria-labelledby="Machineimage-tab">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <p>Add a line</p>
                                            </div>
