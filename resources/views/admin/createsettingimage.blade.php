                    ...
                    <div class="col-lg-8 mt-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ url('insertbackgroundimage') }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="row form-group mt-2">
                                            ...
                                            <div class="col-6">
                                                <input type="text" id="email-input" name="name" class="form-control">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col col-md-2 mt-2"><label class=" form-control-label">Image</label></div>
                                            <div class="col-6">
