    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4">
                        <h4 class="headerborder1">Vendors</h4>
                    </div>
                    <div class="col-md-4">
                    </div>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4 float-left">
                        <a href="{{ url('createpurchase1vendors') }}">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{url('purchase1vendors')}}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                        <a href="{{url('purchase1vendorslist')}}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-header">
                                <strong>ELEMENTS DIAMOND</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="#" method="post" class="form-horizontal">
                                    <div class="row form-group1 mt-2">
                                        <div class="col-lg-3">
                                            <i class="fa fa-user userfont"></i>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="col col-md-8"><label for="hf-email" class=" form-control-label font_size">India</label></div>
                                            <div class="col col-md-8"><i class="fa fa-credit-card"></i> <span>1</span> <i class="fa-solid fa-clock ml-4"></i> </div>
                                        </div>
                                    </div>
                                </form>
                            </div>
