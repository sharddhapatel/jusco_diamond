            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('polishing1lots') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                        <a href="{{ url('polishing1lotslist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>MRG6</td>
                                            <td><button type="button" class="btn btn-secondary btn-sm">laser</button></td>
                                            <td>16</td>
                                            <td>9.25</td>
                                            <td>8.25</td>
                                            <td>3.24</td>
