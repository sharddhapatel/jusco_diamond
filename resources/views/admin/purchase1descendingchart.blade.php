...
<body>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href=""><button type="button" class="btn btn-outline-secondary mt-1"><i
                                    class="fa-solid fa-keyboard"></i> Group By</button></a>
                        <a href=""><button type="button" class="btn btn-outline-secondary mt-1"><i
                                    class="fa-solid fa-star"></i> Favorites</button></a>
                    </div>
                        ...
                        <div class="card">
                            <ul class="stockul">
                                ...
                                <div class="col-md-3 stockli">
                                    ...
                                    <a href="{{ url('purchase1linechart') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-chart-area"></i></button></a>
                                    <a href="{{ url('purchase1piechart') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-chart-pie"></i></button></a>
                                    <a href="{{ url('purchase1stackedchart') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-database"></i></button></a>
                                    <a href="{{ url('purchase1descendingchart') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrow-up-wide-short"></i></button></a>
                                    <a href="{{ url('purchase1ascendingchart') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrow-down-short-wide"></i></button></a>
        ...
        <script src="{{URL:: asset('admin/assets/cdn/js/popper.min.js')}} "></>
