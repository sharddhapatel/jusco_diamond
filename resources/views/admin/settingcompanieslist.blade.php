            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-header">
                                <strong><i class="fa-solid fa-receipt"></i> ASSIANLAB GROWN DIAMONDS LLP</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="#" method="post" class="form-horizontal">
                                    <div class="row form-group1 mt-2">
                                        <div class="col col-md-3"><label for="hf-email" class=" form-control-label font_size">EMAIL :</label></div>
                                        <div class="col col-md-9"><label for="hf-email" class=" form-control-label font_size">infoxyz@gmail.com </label></div>
                                    </div>
                                </form>
                            </div>
                        </div>
