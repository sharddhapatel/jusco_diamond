                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="card">
                                        <div class="card-header">
                                            <button type="button" class="btn btn-success btn-sm float-left">Laser-6</button>
                                            <button type="button" class="btn btn-info btn-sm float-right">Rs.0.00</button>
                                        </div>
                                        <div class="card-body card-block">
                                            <form action="#" method="post" class="form-horizontal">
                                                <div class="row form-group1">
                                                    <div class="col-lg-6"><i class="fa-solid fa-camera"></i></div>
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size">Model :</label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    <div class="col-lg-6"></div>
                                                    <div class="col col-md-6"><label for="hf-password" class=" form-control-label font_size">Serial No :</div>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
