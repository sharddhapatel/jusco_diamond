    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4">
                        <h4 class="headerborder1">Jangad</h4>
                    </div>
                    <div class="col-md-4">
                    </div>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('Jangadlist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                        <a href="{{ url('jangad') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>ANKUSHBHAI</td>
                                            <td>18/08/2022 19:02:56</td>
                                            <td>12/08/2022 11:43:02</td>
                                            <td>0</td>
                                            <td>0.00</td>
                                            <td>0.00</td>
                                            <td>0.00</td>
                                            <td>0.00</td>
                                            <td>0.00</td>
                                            <td><button type="button" class="btn btn-success btn-sm">Received</button></td>
                                        </tr>
                                        <tr>
                                            <td>1</td>
                                            <td> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                                            ...
                                            <td>0.00</td>
                                            <td>0.00</td>
                                            <td><button type="button" class="btn btn-secondary btn-sm">Draft</button></td>
                                        </tr>
                                        <tr>
                                            <td>1</td>
                                            <td> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                                        ...
                                        <tr>
                                            ...
                                            <td>0.00</td>
                                            <td>0.00</td>
                                            <td><button type="button" class="btn btn-primary btn-sm">Assigned</button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
