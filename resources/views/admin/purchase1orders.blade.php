    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4">
                        <h4 class="headerborder1">Purchase Orders</h4>
                    </div>
                    <div class="col-md-4">
                    </div>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"> Reference</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>10/03/2022</td>
                                            <td>ELEMENTS DIAMODS</td>
                                            <td>10/03/2022 11:06:10</td>
                                            <td><button type="button" class="btn btn-info btn-sm">A</button> Administrator</td>
                                            <td style="text-align:center;"><i class="fa-solid fa-clock"></i></td>
                                            <td></td>
                                            <td>Rs.20,050.00</td>
                                            <td><button type="button" class="btn btn-success btn-sm">Waiting Bills</button></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td> <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
