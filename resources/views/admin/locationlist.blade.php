    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4">
                        <h4 class="headerborder1"> Location </h4>
                    </div>
                    <div class="col-md-4">
                    </div>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-4 float-left">
                        <a href="{{ url('createlocation') }}"><button type="button" class="btn btn-outline-secondary mt-1">Create</button></a>
                    </div>
                    <div class="col-md-7">
                    ...
                    <div class="col-md-1 float-right">
                        <a href="{{ url('locationlist') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-arrows-to-dot"></i></button></a>
                        <a href="{{ url('location') }}"><button type="button" class="btn btn-outline-secondary mt-1"><i class="fa-solid fa-list"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="card-body card-block">
                                            <form action="#" method="post" class="form-horizontal">
                                                <div class="row form-group1">
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size">Purchase</label></div>
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size"></label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    <div class="col col-md-6"><label for="hf-password" class=" form-control-label font_size">Company : ASIANLAB</label></div>
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size">Dept : Chocolate</label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    <div class="col col-md-6"><label for="hf-password" class=" form-control-label font_size">GROWN DIAMONDS</label></div>
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size"></label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    <div class="col col-md-6"><label for="hf-password" class=" form-control-label font_size">LLP</label></div>
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size"></label></div>
                                                </div>
                                            </form>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body card-block">
                                            <form action="#" method="post" class="form-horizontal">
                                                ...
                                                <div class="row form-group1">
                                                    <div class="col col-md-6"><label for="hf-password" class=" form-control-label font_size">Company : ASIANLAB</label></div>
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size">Dept : Laser</label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    <div class="col col-md-6"><label for="hf-password" class=" form-control-label font_size">GROWN DIAMONDS</label></div>
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size"></label></div>
                                    ...
                                    <div class="card">
                                        <div class="card-body card-block">
                                            <form action="#" method="post" class="form-horizontal">
                                                ...
                                                <div class="row form-group1">
                                                    <div class="col col-md-6"><label for="hf-password" class=" form-control-label font_size">Company : ASIANLAB</label></div>
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size">Dept : </label></div>
                                                </div>
                                                <div class="row form-group1">
                                                    <div class="col col-md-6"><label for="hf-password" class=" form-control-label font_size">GROWN DIAMONDS</label></div>
                                                    <div class="col col-md-6"><label for="hf-email" class=" form-control-label font_size"></label></div>
