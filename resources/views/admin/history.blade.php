                    ...
                    <div class="col-sm-4">
                        <div class="page-header float-left">
                            <div class="page-title mt-2 ">
                                <h5 class="headerborder1"><i class="fa  fa-inbox"></i> Inbox </h5>
                    ...
                    <div class="col-sm-8">
                        <div class="page-header float-right">
                            <div class="page-title">
                                <a href=""><button type="button" class="btn btn-outline-secondary mt-1"> Make All Read </button></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <strong class="card-title" v-if="headerText">May 10,2022</strong>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-1">
                                        ...
                                        <div class="col-md-11">
                                            <strong class="pb-2 display-5">Dinesh B - 2 days ago on CANCEL-PACKET/2022/0007</strong>
                                            <h6>Subject: Request for Packet Cancellation</h6>
                                            <p>Packets : MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474 ,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY
                                                A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474
                                            </p>
                                ...
                                <div class="card-header">
                                    <strong class="card-title" v-if="headerText">May 16,2022</strong>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-1">
                                        ...
                                        <div class="col-md-11">
                                            <strong class="pb-2 display-5">Dinesh B - 2 days ago on CANCEL-PACKET/2022/0008</strong>
                                            <h6>Subject: Request for Packet Cancellation</h6>
                                            <p>Packets : MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474 ,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY
                                                A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474,MAYBY A-P-2474
                                            </p>
                                ...
                                <div class="card-header">
                                    <strong class="card-title" v-if="headerText">May 18,2022</strong>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-1">
                                ...
                                <div class="card-header">
                                    <strong class="card-title" v-if="headerText">June 2,2022</strong>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-1">
