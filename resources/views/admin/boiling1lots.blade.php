...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="card-header">
            <strong class="card-title"><a href="{{ url('centerdepartment') }}"><i class="fa-solid fa-table-columns"></i></a> <a href="boiling1.html">Boiling</a></strong>
            <ul class="stockul">
                ...
                <li class="stockli"><a href="{{ url('boilingend') }}l">Boiling End</a></li>
            </ul>
