...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('centerdepartment') }}"><span>Polishing</span></a>
        ...
        <div class="card-header">
            <strong class="card-title"><a href="{{ url('centerdepartment') }}"><i class="fa-solid fa-table-columns"></i></a> <a href="{{ url('polishing1') }}">Polishing</a></strong>
            <ul class="stockul">
                <li class="stockli"><a href="{{ url('polishing1') }}">Polishing</a></li>
                <li class="stockli mt-2"><a class=" mt-1" data-bs-toggle="modal" data-bs-target="#receiveModal">Receive</a></li>
                <li class="stockli"><a href="{{ url('polishing1lots') }}">Lots</a></li>
                <li class="stockli"><a href="{{ url('polishing1packets') }}">Packets</a></li>
                <li class="stockli"><a class=" mt-1" data-bs-toggle="modal" data-bs-target="#returnstockModal">Return</a></li>
                <li class="stockli"><a href="{{ url('polishing1ends') }}">Polishing End</a></li>
            </ul>
        ...
        <div class="content" style="background-color: rgba(0,0,0,.03);">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-md-2">
                        <h4 class="headerborder1"> Polishing / New </h4>
                    </div>
                    <div class="col-md-7">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href=""><button type="button" class="btn btn-outline-secondary mt-1">Final Done</button></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-8 mt-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs mt-4" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="Polishinglines-tab" data-toggle="tab" href="#Polishinglines" role="tab" aria-controls="home" aria-selected="true">Polishing Lines</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="otherinfo-tab" data-toggle="tab" href="#otherinfo" role="tab" aria-controls="home" aria-selected="true">Other Info</a>
                                    </li>


                                </ul>
                                <div class="tab-content pl-3 p-1" id="myTabContent">
                                    <div class="tab-pane fade show active" id="Polishinglines" role="tabpanel" aria-labelledby="Polishinglines-tab">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card-body">
                                                    <table class="table">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card-body card-block">
                                                    <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                        <div class="row form-group1">
                                                            <div class="col col-md-4"><label class=" form-control-label">Final Weight(Ct) : </label></div>
                                                            <div class="col-12 col-md-8">
                                                                <p class="form-control-static">0.00</p>
                                                            </div>
                                                        </div>
